...
const VoterRegistration: React.FC = () => {
  ...
  const handleVerify = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
        // 1. Check against master registration list
        ...
        // Success: Show the info modal before transitioning to create step
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
          <div className="flex flex-col items-center gap-4">
             ...
             <p className="text-black">{deadlineMessage}</p>
          </div>
      </div>
    );
  }

  // Main Render (Updated with Black and White Theme)
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
            ...
            <div>
                ...
                {step === 'verify' && (
                    <form onSubmit={handleVerify} className="space-y-4">
                        ...
                        <button type="submit" disabled={loading} className="w-full bg-black text-white font-bold py-3 px-4 rounded-lg hover:bg-gray-800 transition-colors disabled:bg-gray-400 flex items-center justify-center">
      ...
      >
        <div className="space-y-4">
            ...
            <p className="text-center">You are about to create your **Username** and **Password** specifically for the **Online Voting Portal**.</p>
      ...
      {/* 2. Post-Creation Confirmation Modal */}
      <SimpleModal 
